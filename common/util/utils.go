...
func ComputeSHA256(data []byte) (hash []byte) {
	//fmt.Println("===ComputeSHA256================")
	def := factory.GetDefault()
	//fmt.Printf("==factory.GetDefault() type:%T==",def)
	//fmt.Println("====ComputeSHA256=======",def)
	//fmt.Println("====data",data)
	//fmt.Println("====&bccsp.SHA256Opts{}",&bccsp.SHA256Opts{})
	hash, err := def.Hash(data, &bccsp.SHA256Opts{})
	//fmt.Println("===========hash",hash)//[213 110 223 124 231 48 20 241 34 225 248 10 249 2 198 177 223 223 99 180 197 126 160 39 81 101 28 155 126 75 234 202]
	//===CSP===
...
func CreateUtcTimestamp() *timestamp.Timestamp {
	fmt.Println("===CreateUtcTimestamp================")
	now := time.Now().UTC()
	secs := now.Unix()
...
func GenerateHashFromSignature(path string, args []byte) []byte {
	fmt.Println("===GenerateHashFromSignature================")
...
func GenerateIDfromTxSHAHash(payload []byte) string {
	fmt.Println("===GenerateIDfromTxSHAHash================")
...
func FindMissingElements(all []string, some []string) (delta []string) {
	fmt.Println("===FindMissingElements================")
...
func ArrayToChaincodeArgs(args []string) [][]byte {
	fmt.Println("===ArrayToChaincodeArgs================")
	bargs := make([][]byte, len(args))
	for i, arg := range args {
		bargs[i] = []byte(arg)
	}
