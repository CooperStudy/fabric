...
func (opts *RSA1024KeyGenOpts) Algorithm() string {
	//logger.Info("===RSA1024KeyGenOpts==Algorithm===")
	return RSA1024
}
...
func (opts *RSA1024KeyGenOpts) Ephemeral() bool {
	//logger.Info("===RSA1024KeyGenOpts==Ephemeral===")
...
func (opts *RSA2048KeyGenOpts) Algorithm() string {
	//logger.Info("===RSA2048KeyGenOpts==Algorithm===")
	return RSA2048
}
...
func (opts *RSA2048KeyGenOpts) Ephemeral() bool {
	//logger.Info("===RSA2048KeyGenOpts==Ephemeral===")
	return opts.Temporary
}
...
func (opts *RSA3072KeyGenOpts) Algorithm() string {
	//logger.Info("===RSA3072KeyGenOpts==Algorithm===")
	return RSA3072
}
...
func (opts *RSA3072KeyGenOpts) Ephemeral() bool {
	//logger.Info("===RSA3072KeyGenOpts==Ephemeral===")
	return opts.Temporary
}
...
func (opts *RSA4096KeyGenOpts) Algorithm() string {
	//logger.Info("===RSA4096KeyGenOpts==Algorithm===")
	return RSA4096
}
...
func (opts *RSA4096KeyGenOpts) Ephemeral() bool {
	//logger.Info("===RSA4096KeyGenOpts==Ephemeral===")
	return opts.Temporary
}
