...
func (m *HashingAlgorithm) GetName() string {
	logger.Info("===HashingAlgorithm==GetName==")
	if m != nil {
		return m.Name
	}
	return ""
...
func (m *BlockDataHashingStructure) GetWidth() uint32 {
	logger.Info("===BlockDataHashingStructure==GetWidth==")
	if m != nil {
		return m.Width
	}
	return 0
...
func (m *Consortium) GetName() string {
	logger.Info("===Consortium==GetName==")
	if m != nil {
		return m.Name
	}
	return ""
...
func (m *Capabilities) GetCapabilities() map[string]*Capability {
	logger.Info("===Capabilities==GetCapabilities==")
	if m != nil {
