...
func (s *SystemChannel) ProcessNormalMsg(msg *cb.Envelope) (configSeq uint64, err error) {
	logger.Info("==SystemChannel==ProcessNormalMsg==")
...
func (s *SystemChannel) ProcessConfigUpdateMsg(envConfigUpdate *cb.Envelope) (config *cb.Envelope, configSeq uint64, err error) {
	logger.Info("==SystemChannel==ProcessConfigUpdateMsg==")
...
func (s *SystemChannel) ProcessConfigMsg(env *cb.Envelope) (*cb.Envelope, uint64, error) {
	logger.Info("==SystemChannel==ProcessConfigMsg==")
...
func (dt *DefaultTemplator) NewChannelConfig(envConfigUpdate *cb.Envelope) (channelconfig.Resources, error) {
	logger.Info("==DefaultTemplator==NewChannelConfig==")
	...
	logger.Info("=========configUpdate.ChannelId==========",configUpdate.ChannelId)
	logger.Info("=========channelHeader.ChannelId==========",channelHeader.ChannelId)
