	...
	for {
		...
		if envelope != nil {
			...
			/*
				type= 5是请求者的creator
			*/
			logger.Infof("=================a.OrgPki:%v", a.OrgPki)       //Org1MSP=======
			logger.Infof("=================a.Type:%v", a.Type)           //1
...
func (h *Handler) deliverBlocks(ctx context.Context, srv *Server, envelope *cb.Envelope) (status cb.Status, err error) {
	...
	*/
	...
	for {
		...
		//		var bd cb.BlockData
		//		//遵循规则
		//		logger.Infof("=================len(block.Data.Data):%v=====================", len(block.Data.Data))
		...
		//
		//			if a.Type == 1 {
		//				logger.Info("================HeaderType_Config=================")
		//				logger.Info("===========主节点名===========", a.OrgName) //Org1MSP
		//
		//				txid_signed = a.OrgPki
		//				logger.Info("===========交易发送者============", txid_signed) //Org1MSP
		//				/*
		...
		//			} else if a.Type == 3 {
		//				//instantiate比较特殊，
		//				logger.Info("=========HeaderType_ENDOSER_TRANSACTION=======")
		//
		//				payloadSignatureHeader := &cb.SignatureHeader{}
		//				err = proto.Unmarshal(pa.Header.SignatureHeader, payloadSignatureHeader)
		//				creator := payloadSignatureHeader.Creator
		...
		//				err = proto.Unmarshal(creator, sid)
		//				logger.Info("==============交易打包者=========================", txid_order) //""
		//				//type为3的没有交易打包者的痕迹，因为是cli直接发过来的，所以有cli的签名，creator是消息的创建者和发送者
		//
		//				master := cb.PolicyOrgName[a.ChannelId]
		...
		//			sid := &msp.SerializedIdentity{}
		//			err = proto.Unmarshal(creator, sid)
		//			logger.Info("==============交易creator.Org1MSP=========================", sid.Mspid)
		//
		//		}
		//		block.Data.Data = bd.Data
		//	}
		//}
		logger.Info("===========3.len(block.Data.Data)====================", len(block.Data.Data))
